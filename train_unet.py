...
#model 
unet = CustomUNet2D(image_shape=(503, 136, 1))
...
log_dir = 'classification/test/Unet_png/logs_21_10_2020__head'
...
with open('classification/test/Unet'+'/'+hist_json_file, mode = 'w') as f : 
    hist_df.to_json(f)
print("history saved")

#save 
folder = 'classification/test/Unet_png'
if not os.path.exists(folder) : 
    os.makedirs(folder)
model.save(folder + '/' + 'unet_model_head', save_format='h5')
